...
# 输出表格到CSV文件
result_df.to_csv(f"cross_{MAJOR_TO_ANALYZE}.csv", index=False)
...
save_path = os.path.join(save_dir, f'cross_{MAJOR_TO_ANALYZE}_{best_alpha:.4f}.png')
