...
MAJOR_TO_ANALYZE = ALL_LABELS[2]  # 选择要分析的专业标签，修改为其他标签可进行不同专业的分析
...
# 输出表格到CSV文件
result_df.to_csv(f"{MAJOR_TO_ANALYZE}.csv", index=False)
...
save_path = os.path.join(save_dir, f'{MAJOR_TO_ANALYZE}_{best_alpha:.4f}.png')
