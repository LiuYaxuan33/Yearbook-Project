...
y = df[MAJOR_TO_ANALYZE]  # 选择要分析的专业标签
# 输出稀疏矩阵维度
...
# 输出表格到CSV文件
result_df.to_csv(f"new_2-grams_for_{MAJOR_TO_ANALYZE}.csv", index=False)
...
save_dir = './results_major_comparison'
# 确保目录存在
os.makedirs(save_dir, exist_ok=True)
save_path = os.path.join(save_dir, f'2-gram_for_{MAJOR_TO_ANALYZE}_{best_alpha:.4f}.png')
